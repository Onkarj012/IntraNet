...
from optinet.v5_runtime.broker import make_broker, UpstoxBroker
from optinet.v5_runtime.orders import (
...
def run_shadow_checklist(broker, trade_date: str, paper_rows: pd.DataFrame,
    ...
    for _, row in paper_rows.iterrows():
        ...
        try:
            from optinet.v5_runtime.runtime_config import next_weekly_expiry
