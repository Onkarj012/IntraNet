...
def test_p0_2_feature_contract():
    ...
    if csv_path.exists():
        ...
        from equity.feature_contract import flatten_intraday_window
        from equity.features.session_features import compute_session_features
        ...
        from equity.open_safe_daily_features import DAILY_FEATURE_FAMILY_PREFIXES
...
def test_p0_3_calibration():
    ...
    from equity.calibrator import save_calibrator, load_calibrator
