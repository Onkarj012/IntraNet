...
from optinet_router.futures_features import FUTURES_FEATURES, add_regime, compute_features
...
def _load_replay_day(target_date: date) -> pd.DataFrame:
    ...
    from optinet.v5_futures import discover_fut_days
    ...
    if fut_path.exists() and spot_path.exists():
        from optinet_router.futures_features import _load_one_day
