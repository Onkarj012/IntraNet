...
from index_options.math import implied_volatility
...
def build_training_frame(
    ...
    *,
    ...
    if include_sentiment_cache:
        try:
            from index_options.sentiment import load_sentiment_cache
    ...
    if include_gdelt:
        try:
            from index_options.gdelt import load_gdelt_cache
    ...
    if include_regime:
        try:
            from index_options.regime import compute_regime
