...
from equity.calibrator import load_calibrator as _load_calibrator_file
from equity.feature_contract import FEATURE_SCHEMA
...
def calibrate_probabilities(
    ...
    import numpy as np
    from equity.calibrator import apply_calibration
